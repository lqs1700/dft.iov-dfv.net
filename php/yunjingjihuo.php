...
include'db.php';
$page_size=100;
$collect="SELECT count(*) FROM dfqc.dev_user a, dfqc.dev_store b WHERE a.devid = b.devicenumber AND a.username NOT IN ('张三', '联创测试') AND b.devicenumber LIKE '%yj%'";
$result=DB($collect);
...
$key.='</div>';
require "../html/yunjingjihuo.html";